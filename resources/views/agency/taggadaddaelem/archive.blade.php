...
<nav class="fa-solid" >
      <a href="{{ url('/Evacuation/taggadaddaelem') }}">
    ...
    <div class="row" style="margin:20px;">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Tagga-Dadda Elementary School ( Archive )</h2>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->date_leave}}</td>
                                    ...
                                    <form method="POST" action="{{ url('Evacuation/taggadaddaelem/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                            {{ csrf_field() }}
                                    ...
                                    <form method="POST" action="{{ url('Evacuation/taggadaddaelem/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
