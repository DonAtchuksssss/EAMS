...
<nav class="fa-solid">
    <a href="{{ url('/Evacuation/namabbalannorte') }}">
...
<div class="row" style="margin:20px;">
    ...
    <div class="card">
        <div class="card-header">
            <h2>Namabbalan Norte Multi-Purpose Hall ( Archive )</h2>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ url('Evacuation/namabbalannorte/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ csrf_field() }}
                                ...
                                <form method="POST" action="{{ url('Evacuation/namabbalannorte/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
