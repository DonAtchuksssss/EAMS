...
<div class="card" style="margin:20px;">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('Evacuation/atulayanelem') }}" method="post">
        {!! csrf_field() !!}
        <input type="hidden" name="loc_id" value="3" id="name" class="form-control"></br>
      ...
      <input type="text" name="room" class="form-control" required style="width: 30%;"></br>
        ...
        <input type="hidden" name="evacuation" id="mobile" value="Atulayan Elementary School"class="form-control"></br>
