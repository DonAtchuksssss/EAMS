...
<nav class="fa-solid">
    <a href="{{ url('/Evacuation/atulayannhall') }}">
...
<div class="row" style="margin:20px;">
    ...
    <div class="card">
        <div class="card-header">
            <h2>Atulayan Norte Multi-Purpose Hall ( Archive )</h2>
        </div>
                ...
                <table class="table" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ url('Evacuation/atulayannhall/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ csrf_field() }}
                                ...
                                <form method="POST" action="{{ url('Evacuation/atulayannhall/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
