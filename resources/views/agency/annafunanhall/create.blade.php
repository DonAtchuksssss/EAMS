...
<div class="card" style="margin:20px;">
  ...
  <div class="card-body">
    ...
    <form action="{{ url('Evacuation/annafunanhall') }}" method="post">
      {!! csrf_field() !!}
      <input type="hidden" name="loc_id" value="1" id="name" class="form-control"></br>
      ...
      <input type="hidden" name="evacuation" id="mobile" value="Annafunan East Barangay Hall" class="form-control"></br>
