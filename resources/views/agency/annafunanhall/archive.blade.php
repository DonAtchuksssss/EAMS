...
<nav class="fa-solid">
    <a href="{{ url('/Evacuation/annafunanhall') }}">
...
<div class="row" style="margin:20px;">
    <div class="card">
        <div class="card-header">
            <h2>Annafunan East Barangay Hall ( Archive )</h2>
        </div>
        <div class="card-body">
                ...
                <table class="table" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ url('Evacuation/annafunanhall/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ csrf_field() }}
                                ...
                                <form method="POST" action="{{ url('Evacuation/annafunanhall/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
