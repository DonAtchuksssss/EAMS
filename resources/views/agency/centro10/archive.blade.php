...
<nav class="fa-solid">
    <a href="{{ url('/Evacuation/centro10') }}">
...
<div class="row" style="margin:20px;">
    ...
    <div class="card">
        <div class="card-header">
            <h2>Centro 10 Multi-Purpose Hall ( Archive )</h2>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ url('Evacuation/centro10/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ csrf_field() }}
                                ...
                                <form method="POST" action="{{ url('Evacuation/centro10/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
