...
<nav class="fa-solid" >
      <a href="{{ url('/Evacuation/libagsur') }}">
    ...
    <div class="row" style="margin:20px;">
            ...
            <div class="card">
                <div class="card-header">
                    <h2>Libag Sur Multi-Purpose Hall ( Archive )</h2>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->date_leave}}</td>
                                    ...
                                    <form method="POST" action="{{ url('Evacuation/libagsur/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                            {{ csrf_field() }}
                                    ...
                                    <form method="POST" action="{{ url('Evacuation/libagsur/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
