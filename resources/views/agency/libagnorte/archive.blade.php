...
<nav class="fa-solid">
    <a href="{{ url('/Evacuation/libagnorte') }}">
...
<div class="row" style="margin:20px;">
    ...
    <div class="card">
        <div class="card-header">
            <h2>Libag Norte Multi-Purpose Hall ( Archive )</h2>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{ url('Evacuation/libagnorte/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ csrf_field() }}
                                ...
                                <form method="POST" action="{{ url('Evacuation/libagnorte/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
