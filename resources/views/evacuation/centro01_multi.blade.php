...
<body onload="initClock()">
    ...
    <section class="home-section">
        ...
        <div class="map-content">
            ...
            <div class="input-group" >
                <input type="text" class="form-control" placeholder="Destination" id="to" value="Cataggaman Viejo Barangay Hall, Atal St, Tuguegarao City, Cagayan, Philippines">
            </div>

            <div class="icon-direction col-xs-offset2 col-xs-10" >
                <button onclick="Map();" class="btn btn-info btn-xs" ><i class="bx bxs-direction-right" style="height: 50px;"></i></button>
            </div>
