    ...
    <section class="home-section">
        ...
        <div class="map-content">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Destination" id="to" value="BARANGAY ANNAFUNAN EAST BARANGAY HALL, Balisi St, Tuguegarao City, Cagayan, Philippines">
            </div>
