    ...
    <section class="home-section">
        ...
        <div class="map-content">
            ...
            <i class="fa-solid fa-location-dot icon"></i>
                <input type="text" class="form-control" placeholder="Destination" id="to" value="Tuguegarao East Central School, Rizal Street, Tuguegarao City, Cagayan, Philippines">
            </div>
