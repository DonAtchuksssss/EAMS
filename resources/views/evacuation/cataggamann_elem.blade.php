    ...
    <section class="home-section">
        ...
        <div class="map-content">
            ...
            <i class="fa-solid fa-location-dot icon"></i>
                <input type="text" class="form-control" placeholder="Destination" id="to" value="Cataggaman Nuevo Elementary School, New Provincial Road, Tuguegarao City, Cagayan, Philippines">
            </div>
