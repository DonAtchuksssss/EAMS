    ...
    <section class="home-section">
        ...
        <div class="map-content">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Destination" id="to" value="Atulayan norte barangay hall and gymnasium, F Danao Street, Tuguegarao City, Cagayan, Philippines">
            </div>
