          ...
          <div class="cards-body">
            ...
            <div class="tablse-responsive" style="padding: 20px;">
              ...
              <div class="card" style="margin:20px;">
                <div class="card-header">Edit Hotline</div>
                <div class="card-body">
                  <form action="{{ url('systemadmin/hotline/' .$evac[0]->id) }}" method="post">
                    {!! csrf_field() !!}
                    @method("PATCH")
                    <label>Agency</label></br>
                    <input type="hidden" name="id" id="id" value="{{$evac[0]->id}}" id="id" />
                    <input type="text" name="agency" value="{{$evac[0]->agency}}" class="form-control" required></br>
                    <label>Hotline</label></br>
                    <input type="text" name="hotline" value="{{$evac[0]->hotline}}" class="form-control" required></br>
