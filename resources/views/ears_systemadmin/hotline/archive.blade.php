...
<body>
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a class="active" href="{{ url('/systemadmin/user') }}">
                    ...
                    <div class="cards-body">
                        ...
                        <div class="tablse-responsive" style="padding: 20px;">
                            ...
                            <div class="card" style="margin:20px;">
                                <div class="card-header">Archived Hotlines</div>
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" action="{{ url('systemadmin/hotline/restore' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                        {{ csrf_field() }}
                                                    ...
                                                    <form method="POST" action="{{ url('systemadmin/hotline/forceDelete' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
