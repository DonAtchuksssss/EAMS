                        ...
                        <div class="tablse-responsive" style="padding: 20px;">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ url('systemadmin/news/' . $item->id . '/edit') }}" title="Edit Disaster News"><button class="btn btn-primary btn-sm" style="width:100px; padding:10px; margin-left:auto; margin-right:auto; display:block"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
