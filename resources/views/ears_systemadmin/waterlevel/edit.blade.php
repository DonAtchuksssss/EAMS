...
<body>
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="{{ url('/systemadmin/waterlevel') }}" class="active">
          ...
          <div class="cards-body">
            ...
            <div class="tablse-responsive" style="padding: 20px;">
              <div style="margin: 10px;">
                ...
                <a href="{{ url('systemadmin/waterlevel') }}" class="btn btn-secondary btn-sm" title="Add New Student">
                  Back
                </a>
                <br />
              </div>
              <div class="card" style="margin:20px;">
                <div class="card-header">Edit Water level</div>
                <div class="card-body">
                  <form action="{{ url('systemadmin/waterlevel/' .$evac[0]->id) }}" method="post">
                    {!! csrf_field() !!}
                    @method("PATCH")
                    <label>Agency</label></br>
                    <input type="hidden" name="id" id="id" value="{{$evac[0]->id}}" id="id" />
                    <input type="text" name="level" value="{{$evac[0]->level}}" class="form-control" required></br>
