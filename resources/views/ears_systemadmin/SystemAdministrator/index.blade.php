                    ...
                    <div class="cards-body">
                        ...
                        <div class="tablse-responsive" style="padding: 20px;">
                            <div style="margin: 10px;">
                                <a href="{{ url('systemadmin/systemadmin/create') }}" class="btn btn-success btn-sm" title="Add New System Administrator">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->barangay }}</td>
                                        <td>
                                            <a href="{{ url('systemadmin/systemadmin/' . $item->id . '/edit') }}" title="Edit Hotline"><button class="btn btn-primary btn-sm" style="width:50px"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>

                                            <form method="POST" action="{{ url('systemadmin/systemadmin' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline;">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
