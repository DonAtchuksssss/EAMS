...
class SystemadminAccountsController extends Controller
{
    public function index()
    {
        ...
        ->where('role','=',2 )
        ->get();
        return view('ears_systemadmin.SystemAdministrator.index', ['hotlines'=>$hotlines]);
    }
    ...
    {
        return view('ears_systemadmin.SystemAdministrator.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('systemadmin/systemadmin')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function edit($id)
    {
        $evac = DB::table('users')
            ->where('id', '=', $id)
            ->get();
        return view('ears_systemadmin.SystemAdministrator.edit', ['evac' => $evac]);
    }
    /**
     * Show the form for editing the specified resource.
     *
    ...
    { 
        ...
        return redirect('systemadmin/systemadmin')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        $evac = user::onlyTrashed()
            ->select('*')
            ->get();
        return view('ears_systemadmin.SystemAdministrator.archive', ['evac' => $evac]);
    }
    public function archive($id)
    {
        $evac = user::findOrFail($id);
        $evac->delete();
        return redirect('systemadmin/systemadmin')->with('flash_message', 'Student deleted!');
    }
