...
class LarionelemController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.larionelem.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.larionelem.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/larionelem')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.larionelem.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.larionelem.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/larionelem')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','23')
        ->get();
        return view ('agency.larionelem.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/larionelem')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/larionelem/archive')->with('flash_message', 'Student deleted!');
