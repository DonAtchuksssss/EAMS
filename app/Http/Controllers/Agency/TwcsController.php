...
class TwcsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.twcs.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.twcs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/twcs')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.twcs.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.twcs.edit',['evac'=> $evac]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Evacuation/twcs')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','36')
        ->get();
        return view ('agency.twcs.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/twcs')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/twcs/archive')->with('flash_message', 'Student deleted!');
