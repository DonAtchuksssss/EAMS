...
class SangabController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.sangab.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.sangab.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/sangab')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.sangab.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.sangab.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/sangab')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','28')
        ->get();
        return view ('agency.sangab.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/sangab')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/sangab/archive')->with('flash_message', 'Student deleted!');
