...
class UgacsurController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.ugacsur.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.ugacsur.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/ugacsur')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.ugacsur.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.ugacsur.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/ugacsur')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','38')
        ->get();
        return view ('agency.ugacsur.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/ugacsur')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/ugacsur/archive')->with('flash_message', 'Student deleted!');
