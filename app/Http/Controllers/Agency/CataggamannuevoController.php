...
class CataggamannuevoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.cataggamannuevo.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.cataggamannuevo.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/cataggamannuevo')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('cataggamannuevo.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.cataggamannuevo.edit',['evac'=> $evac]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Evacuation/cataggamannuevo')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','13')
        ->get();
        return view ('agency.cataggamannuevo.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/cataggamannuevo')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/cataggamannuevo/archive')->with('flash_message', 'Student deleted!');
