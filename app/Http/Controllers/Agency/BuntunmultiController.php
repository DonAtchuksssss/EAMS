...
class BuntunmultiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.buntunmulti.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.buntunmulti.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/buntunmulti')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.buntunmulti.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.buntunmulti.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/buntunmulti')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','10')
        ->get();
        return view ('agency.buntunmulti.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/buntunmulti')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/buntunmulti/archive')->with('flash_message', 'Student deleted!');
