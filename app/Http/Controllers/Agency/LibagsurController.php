...
class LibagsurController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.libagsur.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.libagsur.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/libagsur')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.libagsur.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.libagsur.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/libagsur')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','25')
        ->get();
        return view ('agency.libagsur.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/libagsur')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/libagsur/archive')->with('flash_message', 'Student deleted!');
