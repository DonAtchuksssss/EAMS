...
class BalzainwhallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.balzainwhall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.balzainwhall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/balzainwhall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.balzainwhall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.balzainwhall.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/balzainwhall')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','9')
        ->get();
        return view ('agency.balzainwhall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/balzainwhall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/balzainwhall/archive')->with('flash_message', 'Student deleted!');
