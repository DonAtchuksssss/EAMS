...
class LibagnorteController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.libagnorte.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.libagnorte.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/libagnorte')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.libagnorte.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.libagnorte.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/libagnorte')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','24')
        ->get();
        return view ('agency.libagnorte.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/libagnorte')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/libagnorte/archive')->with('flash_message', 'Student deleted!');
