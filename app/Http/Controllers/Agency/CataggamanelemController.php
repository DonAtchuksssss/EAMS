...
class CataggamanelemController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.cataggamanelem.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.cataggamanelem.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/cataggamanelem')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.cataggamanelem.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.cataggamanelem.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/cataggamanelem')->with('flash_message', 'student Updated!'); 
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','12')
        ->get();
        return view ('agency.cataggamanelem.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/cataggamanelem')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/cataggamanelem/archive')->with('flash_message', 'Student deleted!');
