...
class TaggadaddaelemController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.taggadaddaelem.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.taggadaddaelem.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/taggadaddaelem')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.taggadaddaelem.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.taggadaddaelem.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/taggadaddaelem')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','29')
        ->get();
        return view ('agency.taggadaddaelem.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/taggadaddaelem')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/taggadaddaelem/archive')->with('flash_message', 'Student deleted!');
