...
class CataggamanviejoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.cataggamanviejo.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.cataggamanviejo.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/cataggamanviejo')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.cataggamanviejo.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.cataggamanviejo.edit',['evac'=> $evac]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Evacuation/cataggamanviejo')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','15')
        ->get();
        return view ('agency.cataggamanviejo.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/cataggamanviejo')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/cataggamanviejo/archive')->with('flash_message', 'Student deleted!');
