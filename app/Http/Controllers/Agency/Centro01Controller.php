...
class Centro01Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.centro01.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.centro01.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/centro01')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.centro01.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.centro01.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/centro01')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','16')
        ->get();
        return view ('agency.centro01.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/centro01')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/centro01/archive')->with('flash_message', 'Student deleted!');
