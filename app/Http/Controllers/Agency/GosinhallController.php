...
class GosinhallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.gosinhall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.gosinhall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/gosinhall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.gosinhall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.gosinhall.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/gosinhall')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','20')
        ->get();
        return view ('agency.gosinhall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/gosinhall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/gosinhall/archive')->with('flash_message', 'Student deleted!');
