...
class TncsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('agency.tncs.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.tncs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/tncs')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.tncs.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.tncs.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/tncs')->with('flash_message', 'student Updated!'); 
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','34')
        ->get();
        return view ('agency.tncs.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/tncs')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/tncs/archive')->with('flash_message', 'Student deleted!');
