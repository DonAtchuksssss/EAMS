...
class BagayController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.bagay.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.bagay.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/bagay')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.bagay.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.bagay.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/bagay')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','6')
        ->get();
        return view ('agency.bagay.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/bagay')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/bagay/archive')->with('flash_message', 'Student deleted!');
