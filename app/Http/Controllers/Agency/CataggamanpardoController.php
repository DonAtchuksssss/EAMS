...
class CataggamanpardoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.cataggamanpardo.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.cataggamanpardo.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/cataggamanpardo')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.cataggamanpardo.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.cataggamanpardo.edit',['evac'=> $evac]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Evacuation/cataggamanpardo')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','14')
        ->get();
        return view ('agency.cataggamanpardo.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/cataggamanpardo')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/cataggamanpardo/archive')->with('flash_message', 'Student deleted!');
