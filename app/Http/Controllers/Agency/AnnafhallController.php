...
class AnnafhallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('agency.annafunanhall.index', ['evac' => $evac]);
    }
    ...
    {
        return view('agency.annafunanhall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/annafunanhall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.annafunanhall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        $evac = DB::table('evacuation')
            ...
            ->get();
        return view('agency.annafunanhall.edit', ['evac' => $evac]);
    }
    ...
    { 
        ...
        return redirect('Evacuation/annafunanhall')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        $evac = evacueess::onlyTrashed()
            ...
            ->where('loc_id', '=', '1')
            ->get();
        return view('agency.annafunanhall.archive', ['evac' => $evac]);
    }
    public function archive($id)
    {
        $evac = evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/annafunanhall')->with('flash_message', 'Student deleted!');
    }
    public function restore($id)
    {
        $evac = evacueess::onlyTrashed()->findOrFail($id);
        $evac->restore();
        return redirect('Evacuation/annafunanhall/archive')->with('flash_message', 'Student deleted!');
    }
    ...
    public function printview()
    {
        ...
        ->where('loc_id', '=', '1')
        ->get(['evacuees.*', 'e.brand', 'e.capacity']);
    return view('agency.annafunanhall.print', ['evac' => $evac]);
    }
}
