...
class BalzainehallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.balzainehall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.balzainehall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/balzainehall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.balzainehall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.balzainehall.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/balzainehall')->with('flash_message', 'student Updated!'); 
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','7')
        ->get();
        return view ('agency.balzainehall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/balzainehall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/balzainehall/archive')->with('flash_message', 'Student deleted!');
