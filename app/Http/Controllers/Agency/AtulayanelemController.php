...
class AtulayanelemController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.atulayanelem.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.atulayanelem.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/atulayanelem')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.atulayanelem.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.atulayanelem.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/atulayanelem')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','3')
        ->get();
        return view ('agency.atulayanelem.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/atulayanelem')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/atulayanelem/archive')->with('flash_message', 'Student deleted!');
