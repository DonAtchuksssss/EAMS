...
class GosishallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.gosishall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.gosishall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/gosishall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.gosishall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.gosishall.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/gosishall')->with('flash_message', 'student Updated!');;  
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','21')
        ->get();
        return view ('agency.gosishall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/gosishall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/gosishall/archive')->with('flash_message', 'Student deleted!');
