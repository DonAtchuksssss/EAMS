...
class NamabbalannorteController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.namabbalannorte.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.namabbalannorte.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/namabbalannorte')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.namabbalannorte.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.namabbalannorte.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/namabbalannorte')->with('flash_message', 'student Updated!'); 
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','26')
        ->get();
        return view ('agency.namabbalannorte.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/namabbalannorte')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/namabbalannorte/archive')->with('flash_message', 'Student deleted!');
