...
class BalzainelemController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.balzainelem.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.balzainelem.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/balzainelem')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.balzainelem.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.balzainelem.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/balzainelem')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','8')
        ->get();
        return view ('agency.balzainelem.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/balzainelem')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/balzainelem/archive')->with('flash_message', 'Student deleted!');
