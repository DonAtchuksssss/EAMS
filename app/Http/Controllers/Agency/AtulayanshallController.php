...
class AtulayanshallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.atulayanshall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.atulayanshall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/atulayanshall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.atulayanshall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.atulayanshall.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/atulayanshall')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','5')
        ->get();
        return view ('agency.atulayanshall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/atulayanshall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/atulayanshall/archive')->with('flash_message', 'Student deleted!');
