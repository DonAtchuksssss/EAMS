...
class AtulayannhallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.atulayannhall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.atulayannhall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/atulayannhall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.atulayannhall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.atulayannhall.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/atulayannhall')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','4')
        ->get();
        return view ('agency.atulayannhall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/atulayannhall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/atulayannhall/archive')->with('flash_message', 'Student deleted!');
