...
class UgacnorteController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.ugacnorte.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.ugacnorte.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/ugacnorte')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.ugacnorte.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.ugacnorte.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/ugacnorte')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','37')
        ->get();
        return view ('agency.ugacnorte.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/ugacnorte')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/ugacnorte/archive')->with('flash_message', 'Student deleted!');
