...
class TecsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.tecs.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.tecs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/tecs')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.tecs.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.tecs.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/tecs')->with('flash_message', 'student Updated!'); 
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','33')
        ->get();
        return view ('agency.tecs.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/tecs')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/tecs/archive')->with('flash_message', 'Student deleted!');
