...
class TcshsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.tcshs.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.tcshs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/tcshs')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.tcshs.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.tcshs.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/tcshs')->with('flash_message', 'student Updated!'); 
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','32')
        ->get();
        return view ('agency.tcshs.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/tcshs')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/tcshs/archive')->with('flash_message', 'Student deleted!');
