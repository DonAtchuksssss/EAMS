...
class Centro09Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.centro09.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.centro09.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/centro09')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.centro09.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.centro09.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/centro09')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','17')
        ->get();
        return view ('agency.centro09.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/centro09')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/centro09/archive')->with('flash_message', 'Student deleted!');
