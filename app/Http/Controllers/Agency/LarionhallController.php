...
class LarionhallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.larionhall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.larionhall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/larionhall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.larionhall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.larionhall.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/larionhall')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','22')
        ->get();
        return view ('agency.larionhall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/larionhall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/larionhall/archive')->with('flash_message', 'Student deleted!');
