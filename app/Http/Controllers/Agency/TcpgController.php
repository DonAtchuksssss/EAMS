...
class TcpgController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.tcpg.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.tcpg.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/tcpg')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.tcpg.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.tcpg.edit',['evac'=> $evac]);
    ...
    { 
        ...
        return redirect('Evacuation/tcpg')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','31')
        ->get();
        return view ('agency.tcpg.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/tcpg')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/tcpg/archive')->with('flash_message', 'Student deleted!');
