...
class GosischoolController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.gosischool.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.gosischool.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/gosischool')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.gosischool.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.gosischool.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/gosischool')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','19')
        ->get();
        return view ('agency.gosischool.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/gosischool')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/gosischool/archive')->with('flash_message', 'Student deleted!');
