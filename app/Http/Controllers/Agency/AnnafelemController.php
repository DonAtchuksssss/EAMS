...
class AnnafelemController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('agency.annafunanelem.index', ['evac' => $evac]);
    }
    ...
    {
        return view('agency.annafunanelem.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/annafunanelem')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.annafunanelem.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        $evac = DB::table('evacuation')
            ...
            ->get();
        return view('agency.annafunanelem.edit', ['evac' => $evac]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Evacuation/annafunanelem')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        $evac = evacueess::onlyTrashed()
            ...
            ->where('loc_id', '=', '2')
            ->get();
        return view('agency.annafunanelem.archive', ['evac' => $evac]);
    }
    public function archive($id)
    {
        $evac = evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/annafunanelem')->with('flash_message', 'Student deleted!');
    }
    public function restore($id)
    {
        $evac = evacueess::onlyTrashed()->findOrFail($id);
        $evac->restore();
        return redirect('Evacuation/annafunanelem/archive')->with('flash_message', 'Student deleted!');
    }
