...
class TaggahallController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view ('agency.taggahall.index',['evac'=> $evac]);
    }
    ...
    {
        return view('agency.taggahall.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Evacuation/taggahall')->with('flash_message', 'Student Addedd!');
    }
    ...
    public function show($id)
    {
        ...
        return view('agency.taggahall.show')->with('evac', $evac);
    }
    ...
    public function edit($id)
    {
        ...
        ->get();
        return view ('agency.taggahall.edit',['evac'=> $evac]);
    ...
    {  
        ...
        return redirect('Evacuation/taggahall')->with('flash_message', 'student Updated!');
    }
    ...
    public function archiveview()
    {
        ...
        ->where('loc_id','=','30')
        ->get();
        return view ('agency.taggahall.archive',['evac'=> $evac]);
    }
    public function archive( $id)
    {
        $evac= evacueess::findOrFail($id);
        $evac->delete();
        return redirect('Evacuation/taggahall')->with('flash_message', 'Student deleted!');
    ...
    public function restore($id)
    {
        ...
        $evac->restore();
        return redirect('Evacuation/taggahall/archive')->with('flash_message', 'Student deleted!');
